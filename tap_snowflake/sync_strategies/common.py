    ...
    with metrics.record_counter(None) as counter:
        ...
        while row:
            ...
            try:
                ...
                raise SymonException('Forbidden error occured while fetching Snowflake table. This could occur if the table is too large.', 'snowflake.SnowflakeClientError') from e
